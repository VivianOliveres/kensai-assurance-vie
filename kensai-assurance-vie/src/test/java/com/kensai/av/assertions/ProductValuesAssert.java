...
/**
 * {@link ProductValues} specific assertions - Generated by CustomAssertionGenerator.
 */
public class ProductValuesAssert extends AbstractAssert<ProductValuesAssert, ProductValues> {

  /**
   * Creates a new </code>{@link ProductValuesAssert}</code> to make assertions on actual ProductValues.
   * @param actual the ProductValues we want to make assertions on.
   */
  public ProductValuesAssert(ProductValues actual) {
    super(actual, ProductValuesAssert.class);
  }
   ...
   * @param actual the ProductValues we want to make assertions on.
   * @return a new </code>{@link ProductValuesAssert}</code>
   */
   ...
   */
  public ProductValuesAssert hasDate(LocalDate date) {
   ...
   */
  public ProductValuesAssert hasNotationLipperAbsolutePerformances(int notationLipperAbsolutePerformances) {
    // check that actual ProductValues we want to make assertions on is not null.
    isNotNull();
   ...
   */
  public ProductValuesAssert hasNotationLipperCapitalPreservation(int notationLipperCapitalPreservation) {
    // check that actual ProductValues we want to make assertions on is not null.
    isNotNull();
   ...
   */
  public ProductValuesAssert hasNotationLipperRegularPerformances(int notationLipperRegularPerformances) {
    // check that actual ProductValues we want to make assertions on is not null.
    isNotNull();
   ...
   */
  public ProductValuesAssert hasNotationMorningStar(int notationMorningStar) {
    // check that actual ProductValues we want to make assertions on is not null.
    isNotNull();
   ...
   */
  public ProductValuesAssert hasPrice(double price) {
    // check that actual ProductValues we want to make assertions on is not null.
    isNotNull();
	 ...
	 */
	public ProductValuesAssert hasPriceCurrency(String priceCurrency) {
		// check that actual ProductValues we want to make assertions on is not null.
		isNotNull();
	 ...
	 */
  public ProductValuesAssert hasProduct(Product product) {
    // check that actual ProductValues we want to make assertions on is not null.
    isNotNull();
   ...
   */
  public ProductValuesAssert hasSharpeRatio1(double sharpeRatio1) {
    // check that actual ProductValues we want to make assertions on is not null.
    isNotNull();
   ...
   */
  public ProductValuesAssert hasSharpeRatio10(double sharpeRatio10) {
    // check that actual ProductValues we want to make assertions on is not null.
    isNotNull();
   ...
   */
  public ProductValuesAssert hasSharpeRatio3(double sharpeRatio3) {
    // check that actual ProductValues we want to make assertions on is not null.
    isNotNull();
   ...
   */
  public ProductValuesAssert hasSharpeRatio5(double sharpeRatio5) {
    // check that actual ProductValues we want to make assertions on is not null.
    isNotNull();
